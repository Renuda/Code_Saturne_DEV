...
typedef enum {
  ...
  CS_ENUMF_(k_sgs),   /*!< turbulent kinetic energy \f$ k_sgs \f$ */
  CS_ENUMF_(eps),     /*!< turbulent dissipation \f$ \varepsilon \f$ */
  CS_ENUMF_(eps_sgs), /*!< turbulent dissipation \f$ \varepsilon_sgs \f$ */
  ...
  CS_ENUMF_(
    rad_ck_down), /*!< Spectral downward Radiative absorption coefficient */
